"""
Django settings for datev_47943 project.
...
WSGI_APPLICATION = 'datev_47943.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "datev_47943 API",
    "DESCRIPTION": "API documentation for datev_47943 App",
    "VERSION": "v1",
}
